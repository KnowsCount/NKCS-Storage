	...
	effects: {
		...
		*modify({ payload }, { select, call, put }) {
			...
			const id = yield select(
				({ products }) => products.currentItem["_id"]
			);
			const newProduct = { ...payload, id };
			newProduct["productImg"] = newProduct["productImg"]
				? newProduct["productImg"][0]["response"]
				: "";
